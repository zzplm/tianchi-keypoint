...
#can use but not enough if less fast
...
class LoadDataset(Dataset):
    ...
    def __init__(self, img_directory, annotation_path, image_size, heatmap_size, test_mode = False):
        ...
        # self.num_joints = 17
        # self.bbox_file = r'D://coco//coco-2017-dataset//coco2017//annotations//person_keypoints_train2017.json'
        ...
        # self.joint_weights = [1., 1., 1.2, 1.2, 1.5, 1., 1.2, 1.2, 1.5, 1., 1., 1.2, 1.5,1.2,1.5]
        self.joint_weights = [1.2, 1.2, 1.5, 1.]
        self.num_joints = 4
        self.bbox_file = r"C:\Users\28144\Desktop\Feng\TianChi-FashionAi-keypoints\fashionAi_Data\train\annotations\skirt.json"      # ?? Apparently for testing we use bounding boxes and for training we use keypoints: BB are used in the loss function, distances are normalized based on the size of bb. So they should be used in test as well
    ...
    def __getitem__(self, index):
        ...
        #print(index)#
        image_data = self.db[index] #index应该是个值
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
      ...
      for obj in objs:
          ...
          joints_3d_visible[:, :2] = np.minimum(1, keypoints[:, 2:3].astype(int))
